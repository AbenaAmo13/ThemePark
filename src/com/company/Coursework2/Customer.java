...
public class Customer {
    ...
    //First useAttraction. Method to be able to use attraction
    public void useAttraction(int attractionPrice) {
        try {
            if (accountBalance >= attractionPrice) {
                ...
                //If funds aren't enough throw insufficient balance exception.
    ...
    //Overload use Attraction. For RollerCoasters only.
